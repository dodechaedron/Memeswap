...
export const SiwtchUnits: React.FC = () => {
  const CAKE_PRICE = 69;
  const [editingUnit, setEditingUnit] = useState<"HERB" | "USD">("HERB");
  const conversionUnit = editingUnit === "HERB" ? "USD" : "HERB";
  ...
  const switchEditingUnits = () => {
    const editingUnitAfterChange = editingUnit === "HERB" ? "USD" : "HERB";
