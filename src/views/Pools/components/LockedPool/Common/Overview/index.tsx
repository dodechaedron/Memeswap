  ...
  return (
    <>
      <Box>
        ...
        <LightGreyCard>
          <BalanceRow title={t('Herb to be locked')} value={lockedAmount} newValue={newLockedAmount} decimals={2} />
      ...
      {showLockWarning && (
        <Box mt="16px" maxWidth="370px">
          <Message variant="warning">
            <MessageText>
              {t('You will be able to withdraw the staked HERB and profit only when the staking position is unlocked')}
            </MessageText>
          </Message>
        </Box>
      )}
