...
const getFarmQuoteTokenPrice = (
  ...
  if (farm.quoteToken.symbol === 'WTARA') {
    return bnbPriceBusd
  }
  ...
  if (quoteTokenFarm.quoteToken.symbol === 'WTARA') {
...
const getFarmsPrices = (farms: SerializedFarm[]) => {
  const bnbBusdFarm = farms.find((farm) => farm.token.symbol === 'USDC' && farm.quoteToken.symbol === 'WTARA')
