...
const Footer: React.FC<{ variant?: FooterVariant; helpUrl?: string }> = ({
  ...
  return (
    <Wrapper $isSide={isSide}>
      ...
      >
        <BubbleWrapper>
          <Button id="clickExchangeHelp" as="a" external href="https://taraxa.io" variant="subtle">
            {t("Learn more about Taraxa")}
          </Button>
        ...
        <Image src="/images/helpcat.png" alt="HerbSwap" width={115} height={108} />
      </Flex>
    </Wrapper>
  )
}
